...
os.environ.setdefault("STRIPE_CONNECT_WEBHOOK_SECRET", "whsec_connect_test_dummy")
os.environ.setdefault("STRIPE_BILLING_WEBHOOK_SECRET", "whsec_billing_test_dummy")
