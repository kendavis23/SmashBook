...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str                        # Primary (read/write) — always required
    DATABASE_READ_REPLICA_URL: str = ""      # Falls back to primary if empty
    ...
    # Platform admin
    PLATFORM_API_KEY: str = "placeholder-not-used-in-migrations"
