...
import { useCompleteInvitation } from "../hooks";
                        ...
                        <>
                            <div className="mb-8">
                                ...
                                <p className="text-sm text-muted-foreground mt-2">
                                    You&apos;ve been invited to SmashBook. Choose a password to
...
function CompleteInvitationContainer(): JSX.Element {
    ...
    const { mutate, isPending, isSuccess, error, reset } = useCompleteInvitation();
