...
import { panelCls, panelTitleCls, playerDisplayName } from "../playerEngagementConstants";
...
export function EngagementLeaderboardPanel({
    title,
    hint,
    metricLabel,
    rows,
    ...
    return (
        <section
            className={`${panelCls} flex flex-col transition-colors ${
