...
frontend/
├── apps/
│   ├── website/                    # React (Vite) — public marketing website
│   │   └── src/
...
│   │       └── styles/
│   │
│   ├── web-admin/                  # React (Vite) — platform admin app
│   │   └── src/
│   │       ├── app/                # TanStack Router setup
│   │       ├── config/
│   │       ├── features/
│   │       │   └── dashboard/
│   │       ├── layout/
...
│   │       └── styles/
│   │
│   ├── web-staff/                  # React (Vite) — club staff portal
│   │   └── src/
│   │       ├── app/                # TanStack Router setup
│   │       ├── layout/
│   │       │   └── dashboard/      # DashboardLayout, Sidebar, Navbar
│   │       ├── config/
│   │       ├── features/           # auth, booking, calendar, club, court, equipment, membership, etc.
...
│   │       ├── layout/
│   │       │   └── dashboard/      # DashboardLayout, Sidebar, Navbar
│   │       ├── features/           # auth, booking, dashboard, my-games, payment, profile
│   │       ├── providers/
│   │       └── styles/
│   │
...
│   │   └── index.ts
│   │
│   ├── admin-domain/               # 🛡️ platform admin business logic (web-admin)
│   │   ├── hooks/
...
│   │   └── index.ts
│   │
│   ├── staff-domain/               # 🏢 staff business logic (web-staff)
│   │   ├── hooks/
...
| Routing           | React Router DOM + TanStack Router                   | 6.28.0 / ^1.90.0      | React Router for website; TanStack Router for portals |
