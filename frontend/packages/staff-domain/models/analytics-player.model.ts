...
export interface PlayerValueParams {
    members_only?: boolean;
    sort?: PlayerSort;
    limit?: number;
    offset?: number;
...
export interface MostActiveParams {
    window_days?: 30 | 90;
    limit?: number;
    offset?: number;
}

export interface InactiveMembersParams {
    inactive_days?: number;
    limit?: number;
    offset?: number;
}

export interface GroupValueParams {
    dimension?: GroupDimension;
    inactive_days?: number;
}

export interface ActivePlayersKpiParams {
    window_days?: number;
    as_of?: string;
}

export interface PlayerFlowTimeseriesParams {
    granularity?: FlowGranularity;
    date_from?: string;
    date_to?: string;
}
