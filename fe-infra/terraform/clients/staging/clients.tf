...
variable "staff_domain" {
  description = "Full FQDN for the staff portal (e.g. ace-staging.smashbook.app). Leave empty to skip creating staff DNS records."
  type        = string
  default     = ""
}

variable "player_domain" {
  description = "Full FQDN for the player portal (e.g. ace-player-staging.smashbook.app). Leave empty to skip creating player DNS records."
  type        = string
  default     = ""
}
